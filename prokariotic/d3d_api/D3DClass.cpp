...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	// Setup the raster description which will determine how and what polygons will be drawn.(this is default state!!!)
...
void D3DClass::LogAdapters(IDXGIFactory* factory)
{
	unsigned int i = 0;	
	IDXGIAdapter* adapter = nullptr;
	std::vector<IDXGIAdapter*> adapters;

	m_outfile = _wfopen(L"adapters.log", L"w");
...
void D3DClass::BeginScene(float red, float green, float blue, float alpha)
{
	...
	m_deviceContext->ClearRenderTargetView(m_renderTargetView, color);		// Clear the back buffer.	
	m_deviceContext->ClearDepthStencilView(m_depthStencilView, D3D11_CLEAR_DEPTH, 1.0f, 0);		// Clear the depth buffer.
